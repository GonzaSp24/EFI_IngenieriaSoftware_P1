...
def success_response(
    data=None, message="Operación exitosa", status_code=status.HTTP_200_OK
):
    """
    ...
    """
    return Response(
        {"error": False, "message": message, "data": data}, status=status_code
    )
...
def error_response(
    ...
    """
    return Response(
        {"error": True, "message": message, "details": details}, status=status_code
    )
