...
def reporte_pasajeros_vuelo(request, pk):
    ...
    reservas = Reserva.objects.filter(vuelo=vuelo).select_related('pasajero').order_by('pasajero__id')
...
def mis_reservas(request):
    ...
    try:
        ...
        messages.info(request, 'Aún no tenés perfil de pasajero, crealo para ver tus reservas.')
        return redirect('registrar_pasajero')
