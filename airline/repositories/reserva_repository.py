...
class ReservaRepository:
    ...
    def get_by_codigo(codigo_reserva):
        ...
        return (
            Reserva.objects.select_related("vuelo", "pasajero", "asiento")
            .filter(codigo_reserva=codigo_reserva)
            .first()
        )
    ...
    def get_by_vuelo(vuelo_id):
        ...
        """
        return Reserva.objects.select_related("pasajero", "asiento").filter(
            vuelo_id=vuelo_id
        )
    ...
    def get_by_pasajero(pasajero_id):
        ...
        """
        return Reserva.objects.select_related("vuelo", "asiento").filter(
...
class BoletoRepository:
    ...
    def get_all():
        ...
        return Boleto.objects.select_related(
            "reserva__vuelo", "reserva__pasajero"
        ).all()
    ...
    def get_by_id(boleto_id):
        ...
        """
        return (
            Boleto.objects.select_related("reserva__vuelo", "reserva__pasajero")
            .filter(id=boleto_id)
            .first()
        )
    ...
    def get_by_codigo(codigo_barra):
        ...
        return (
            Boleto.objects.select_related("reserva__vuelo", "reserva__pasajero")
            .filter(codigo_barra=codigo_barra)
            .first()
        )
