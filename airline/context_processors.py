...
def airline_info(request):
    ...
    """
    return {
        "AIRLINE_NAME": getattr(
            settings, "AIRLINE_NAME", "Sistema de Gestión de Aerolínea"
        ),
        "AIRLINE_CODE": getattr(settings, "AIRLINE_CODE", "ARL"),
        "AIRLINE_SUPPORT_EMAIL": getattr(
            settings, "AIRLINE_SUPPORT_EMAIL", "support@airline.com"
        ),
    }
